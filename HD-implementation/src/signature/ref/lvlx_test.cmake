...
add_executable(sqisign_test_torsion_unit_${SVARIANT_LOWER} ${LVLX_DIR}/test/torsion_unittests.c)
target_link_libraries(sqisign_test_torsion_unit_${SVARIANT_LOWER} ${LIB_SIGNATURE_${SVARIANT_UPPER}} ${LIB_QUATERNION} ${LIB_VERIFICATION_${SVARIANT_UPPER}} ${GMP} sqisign_common_test sqisign_common_sys)
target_include_directories(sqisign_test_torsion_unit_${SVARIANT_LOWER} PRIVATE ${INC_PUBLIC} ${INC_COMMON} ${INC_ID2ISO} ${INC_HD} ${INC_QUATERNION} ${INC_PRECOMP_${SVARIANT_UPPER}} ${INC_GF} ${INC_GF_${SVARIANT_UPPER}} ${INC_EC} ${INC_VERIFICATION} ${INC_SIGNATURE})
...
add_test(sqisign_test_torsion_unit_${SVARIANT_LOWER} sqisign_test_torsion_unit_${SVARIANT_LOWER} 3)
