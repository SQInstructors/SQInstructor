...
p_toy = {
    ...
    "eBorel": 400,  # Fixed signing exp.
    "eScalar": 600,  # Fixed signing exp. 
...
p6983 = {
    ...
    "e": 1000,  # Fixed signing exp. ~ log(p^4) #old value 1000 
    "eBorel": 1800,  # Fixed signing exp.
    "eScalar": 2500,  # Fixed signing exp. 
